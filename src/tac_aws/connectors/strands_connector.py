...
class StrandsConnector:
    ...
    Example:
        ...
        # Create connector with agent factory. Every channel whose Twilio
        # sender is configured is built for you — set TWILIO_WHATSAPP_NUMBER
        # and connector.whatsapp comes along with SMS.
