 ...
 *
 * A Twilio Function alternative to the AWS Lambda webhook proxy. Routes Twilio
 * webhooks to an AWS Bedrock AgentCore runtime.
 *
 * Endpoints:
 ...
 *
 * Twilio Functions run outside AWS, so they authenticate with IAM access keys
 * (not an IAM role). These are provided as environment variables.
 */
...
/**
 * Generate pre-signed WebSocket URL for AgentCore using the official client.
 */
